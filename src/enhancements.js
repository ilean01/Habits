...
function run(){queued=false;installStyles();enhanceHabitEditor();decorateWeeklyCards();prioritizeWork();addLaterShortcut();installGuide();enrichSettingsInstall();decorateHolidays();decorateHolidayToday();}
...
setInterval(()=>{prioritizeWork();decorateWeeklyCards();},60000);
schedule();
