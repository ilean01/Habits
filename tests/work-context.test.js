...
test('detecta el bloque laboral activo',()=>{assert.equal(activeWorkBlock(events,'2026-09-22','10:30')?.id,'w');assert.equal(activeWorkBlock(events,'2026-09-22','18:00'),null);});
...
test('silencia avisos personales solo si la opción está activa y se está trabajando',()=>{assert.equal(shouldSilencePersonal({quietWork:true},events,'2026-09-22','10:00'),true);assert.equal(shouldSilencePersonal({quietWork:false},events,'2026-09-22','10:00'),false);});
