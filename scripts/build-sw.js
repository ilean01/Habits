...
sw=sw.replace("'habits-shell-v1'",JSON.stringify('habits-shell-'+version)).replace("['./','./icon.svg','./manifest.webmanifest']",JSON.stringify(['./','./biblioteca.html','./icon.svg','./icon-192.png','./icon-512.png','./manifest.webmanifest',...assets]));
